...
.kmsh-contact {
  ...
  border-radius: 16px;
  border: 1px solid var(--kmsh-border);
  background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(250, 240, 228, 0.65));
  box-shadow: var(--kmsh-shadow-soft);
}

.kmsh-contact h4 {
  margin: 0 0 6px;
  color: var(--kmsh-primary-strong);
}
...
home_panel = ui.nav_panel(
    ...
    ui.page_fluid(
        ...
        ui.div(
            {"class": "kmsh-contact"},
            ui.h4("Contact Us"),
            ui.p("Questions, feedback, or collaboration ideas are welcome."),
            ui.p(
                "Email: ",
                ui.tags.a("oliver.runswick@kcl.ac.uk", href="mailto:oliver.runswick@kcl.ac.uk"),
            ),
        ),
    ),
)
...
join_us_panel = ui.nav_panel(
    ...
    ui.page_fluid(
        ...
        ui.p("Original codes & tutorial: ", ui.tags.a('https://github.com/oliverrunswick/KingsModuleHelper', href = 'https://github.com/oliverrunswick/KingsModuleHelper')),
